...
// Sample project data, you should replace this with your own
const projectsData = [
  {
    id: 1,
    title: "Virtual Reality Dashboard",
    description: "An immersive VR dashboard for monitoring real-time data streams with interactive 3D visualizations.",
  ...
  },
  {
    ...
    description: "Interactive visualization tool for neural networks that lets users experiment with different architectures.",
  ...
  },
  {
    ...
    description: "Educational platform for simulating quantum algorithms and visualizing quantum states.",
    tags: ["TypeScript", "React", "Python", "WebAssembly"],
    image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb?auto=format&fit=crop&w=400&h=250"
  },
  {
    id: 4,
    title: "Blockchain Explorer",
    description: "Advanced blockchain explorer with real-time transaction visualization and analytics dashboard.",
  ...
  },
  {
    ...
    description: "Intelligent code assistant that provides contextual suggestions and autocompletion based on your coding patterns.",
    tags: ["Python", "NLP", "React", "TypeScript"],
    image: "https://images.unsplash.com/photo-1439337153520-7082a56a81f4?auto=format&fit=crop&w=400&h=250"
  }
];
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 z-10 relative">
        ...
        >
          Explore my universe of digital creations — from immersive experiences to 
          cutting-edge applications that push technical boundaries.
        </motion.p>
