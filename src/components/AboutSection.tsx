...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="container mx-auto flex gap-8 px-4 z-10 relative"
        style={{ opacity, y }}
      >
          ...
          >
            ...
            >
              <p className="text-lg md:text-md text-gray-200 leading-relaxed mb-6">
                Since the age of 12, technology stopped being just a curiosity
                and became a true passion. I began building simple apps and
                games, driven by a desire to understand what happens behind the
                screen — and today, I turn that passion into impactful code.
              </p>

              <p className="text-lg md:text-md text-gray-200 leading-relaxed">
                My journey has taken me through various languages, frameworks,
                and paradigms, each adding new dimensions to my understanding of
                software development. I believe in creating solutions that are
                not only technically sound but also intuitive and accessible to
                users.
              </p>
